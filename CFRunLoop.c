...
#elif DEPLOYMENT_TARGET_WINDOWS
DWORD GetInternalThreadIdInternal(HANDLE t);

static HANDLE kNilThreadT = 0;
static DWORD __kCFMainThread = 0;
#define pthreadPointer(a) ((void*)GetInternalThreadIdInternal(a))
...
#elif DEPLOYMENT_TARGET_WINDOWS
    __kCFMainThread = GetInternalThreadIdInternal(_CFThreadSelf());
#endif
}
...
typedef struct _CLIENT_ID_Local
{
    DWORD UniqueProcess;
    DWORD UniqueThread;
} CLIENT_ID_Local, * PCLIENT_ID_Local;
